    ...
    <div class="min-h-screen bg-gray-50" style="margin-top: 5rem">
        ...
        <main class="container mx-auto px-4 py-8 animate-fade-in">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Ajouter un nouveau abonnement</h1>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="p-6 md:p-8">
                    <form method="POST" action="{{ route('membership.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="name" name="name" required class="w-full px-4 py-2 border border-gray-300 rounded-lg form-input focus:border-indigo-500 transition form-control">
                                </div>
                                <!-- Email -->
                                <div>
                                <label for="description" class="block text-sm font-medium text-gray-700 mb-1">description*</label>
                                    <input type="text" id="description" name="description" required class="w-full px-4 py-2 border border-gray-300 rounded-lg form-input focus:border-indigo-500 transition form-control @error('description') is-invalid @enderror">
                                    @error('description')
                                ...
                                <div>
                                    ...
                                    <input type="text" id="price" name="price" required class="w-full px-4 py-2 border border-gray-300 rounded-lg form-input focus:border-indigo-500 transition form-control @error('price') is-invalid @enderror">
                                    @error('price')
                                       <div class="invalid-feedback"> {{$message}} </div>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="duration" name="duration" required class="w-full px-4 py-2 border border-gray-300 rounded-lg form-input focus:border-indigo-500 transition form-control @error('duration') is-invalid @enderror">
                                    @error('duration')
                                       <div class="invalid-feedback"> {{$message}} </div>
                                    @enderror
                                </div>                                
